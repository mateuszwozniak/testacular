...
module.exports = function TeamCity(formatError, reportSlow) {
    ...
    this.writeSpecBegin = function (result) {
        this.write(this.createTcOutputLine('testStarted', {
            name: result.suite[0] + ' ' + result.description 
        }));
    }
    ...
    this.createTcOutputLine = function (label, args) {
        var escape = this.escapeForTeamCity;
    ...
    this.escapeForTeamCity = function (message) {
